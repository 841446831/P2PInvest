...
public class ProductInvestFragment extends BaseFragment {
    ...
    class MyAdapter extends BaseAdapter{
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            if(view == null)
            {
                ...
                view = inflater.inflate(R.layout.product_invest_item,null);
                ...
                viewHolder.restTime = (TextView) view.findViewById(R.id.tv_rest_time);
            ...
            long investTime = productInvests.get(i).getStartTime();
            long timeLong = (nowTime - investTime)/(24*3600*1000);

            long restLong = day - timeLong;

            if(restLong % 30 == 0)
            {
                timeString = String.valueOf(restLong/30) + "个月";
            }
            else
            {
                timeString = String.valueOf(restLong) + "天";
            }

            viewHolder.restTime.setText(timeString);
