 ...
 */
public class FinacingTransferFragment extends BaseFragment{
    ...
    public void init(View successView){
        listView = (ListView) successView.findViewById(R.id.lv_transfer);
    }
    ...
    protected String getUrl() {
        return AppNetConfig.TRANSFER_ALL;
    }
    ...
    public int getLayoutId() {
        return R.layout.fragment_finacing_transfer;
    }
    public class  MyAdaper extends BaseAdapter{
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            viewHolder.tv_title.setText(borrowers.get(i).getBorrowPlatform().getName() + "转让");
